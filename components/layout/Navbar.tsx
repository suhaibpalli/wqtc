...
const navLinks = [
  ...
  },
  {
    ...
    submenu: [
      { href: "/courses/men", label: "Free Courses for Men" },
      { href: "/courses/women", label: "Free Courses for Women" },
      { href: "/courses/weekend", label: "Free Weekend Courses" },
    ],
  },
  {
    href: "/contact",
            ...
            <div className="h-16 w-16 flex items-center justify-center transition-transform group-hover:scale-105">
              ...
              >
                <g>
                  ...
                  />
                  <path
                    d="M288.8,249.3c4.2-3.8,7.4-8.8,14.1-9.3c4.3-0.3,7.5,0.3,9.6,4.5c7.3,14.3,14.8,28.5,22,42.8
                  ...
                  />
                  <path
                    d="M496.6,263.5c1.9-9.1,2.9-18.4,5.9-27.1c8.5-24.2,26.2-37.8,51.6-41.4c13.9-2,27.6-1,40.9,3.1
                  ...
                  />
                  <path
                    d="M825.7,359.5c-37.7,0-63.3-24.4-66-62.2c-1.3-18.5,1.2-35.9,11.2-51.7c15.4-24.4,45.7-35.2,75.4-27
                  ...
                  />
                  <path
                    d="M721.2,221.7c-0.6,8.8-1.3,17.2-1.8,25.6c-1.5,25.9-3,51.8-4.4,77.6c-0.5,8.1-4.1,13.2-10.5,14.8
                  ...
                  />
                  <path
                    d="M584.3,566.6c-92.4-41.3-183.5-82.1-274.9-123c1.6-0.9,3.2-1.9,4.9-2.9c42.5-23.5,85-46.9,127.4-70.5
                    c3.2-1.8,5.9-2.1,9.4-1c43.7,13.9,87.4,27.7,131.1,41.6c1.3,0.4,2.6,0.9,3.7,1.3C585.5,463.4,584.9,514.5,584.3,566.6z"
                  />
                  <path
                    d="M1159.3,456.9c-0.2,1.8-0.4,3.4-0.7,5.4c-16.1,6-32.8,12.3-49.5,18.5c-287.3,107.4-574.6,214.7-861.9,322
                  ...
                  />
                  <path
                    d="M270.8,457.1c7.5,3.9,15,7.8,22.5,11.6c222.4,108.9,444.8,217.7,667.3,326.5c1.9,0.9,3.9,1.5,5.8,2.3
